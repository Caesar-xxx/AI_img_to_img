<template>
  ...
  <div id="container">
    ...
    <el-row>
      <el-col :span="12">
      <el-upload class="img-uploader" :action="postUrl" :show-file-list="false"
        :on-success="handleUploadSuccess" :on-error="handlerError">
        <img v-if="uploadImgSrc" :src="uploadImgSrc" class="avatar">
        <i v-else class="el-icon-plus img-uploader-icon"></i>
      </el-upload>
      </el-col>
      <el-col :span="12">
        <el-link type="danger" icon="el-icon-refresh" :href="gindexUrl" target="_blank">重建图片索引</el-link>
      </el-col>
    </el-row>
    ...
    <div id="img_container">
      <el-row>
        <!-- 遍历显示 -->
          <el-image  v-for="(item,index) in imgUrls" :key="index"
            :src="item" 
...
export default {
  ...
  data() {
    return {
      ...
      gindexUrl: 'http://127.0.0.1:5000/manage/gimgindex',
      postUrl: 'http://127.0.0.1:5000/api/img_search',
      imgUrls:[]
    }
  },
  methods: {
